                    ...
                    <div class="">
                        ...
                        <div class="row">
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" novalidate="" action="#" id="certificat">
                                            <span class="section">Certificat de virginité</span>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Examen <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Heure de la certificat <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="col-md-13 xdisplay_inputx form-group has-feedback">
                                                        <input type="text" class="form-control col-md-7 col-xs-12" id="heure" placeholder="Heure" aria-describedby="inputSuccess2Status2" id="heure">
                                                        <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" id="content" style="display:none;">
                                    <center><h1>Certificat de virginité</h1></center>
                                    <div id="certificat_body">
                                        ...
                                        <strong>Certifie avoir examiné à sa demande (ou à la demande du tuteur ou procureur du Roi)  la nommé Mlle :</strong> <div class="patient_nom" style="display:inline;margin-left:10px;margin-right:10px;"></div><div class="patient_prenom" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/> 

                                        <strong>CIN :</strong> <div class="cin" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/> 

                                        <strong>Que l’examen :</strong> <div class="examen" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/>

                                        <strong>Date :</strong> <div class="single_cal2" style="display:inline;margin-left:10px;margin-right:10px;"></div> <strong>Heure :</strong> <div class="heure" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/>
                                        
                                        <p style="margin-top:70px;line-height:1"><strong>Ce certificat est délivré à l’intéressée et remis en main propre pour servir et valoir ce que de droit.</strong></p>
