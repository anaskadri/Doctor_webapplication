                        ...
                        <div class="row">
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" novalidate="" action="#" id="certificat">
                                            <span class="section">Bilan de grossesse</span>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Glycémie à jeun <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Groupage sanguin +rhésus <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">VDRL <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">TPHA <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">SEROLOGIE RUBEOLE <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">SEROLOGIE TOXOPLASMOSE <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">SEROLOGIE HEPATITE B <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">SEROLOGIE HEPATITE C <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">HIV <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Uricémie <span class="required">*</span>
                                                     </label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" id="content" style="display:none;">
                                <div style="font-size: 15pt;text-align:right;">Kenitra, le<div class="single_cal2" style="display:inline;margin-left:10px;margin-right:10px;"></div></div>
                                    <center><h1>BILAN DE GROSSESSE</h1></center>
                                    <div id="certificat_body">
                                        <center><strong>Mme, </strong> <div class="patient_nom" style="display:inline;margin-left:10px;margin-right:10px;"></div><div class="patient_prenom" style="display:inline;margin-left:10px;margin-right:10px;"></div></center><br/>
                                         
                                        <div>NFS<div id="i1" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Glycémie à jeun<div id="i2" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Groupage sanguin +rhésus<div id="i3" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>VDRL<div id="i4" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>TPHA<div id="i5" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>SEROLOGIE RUBEOLE<div id="i6" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>SEROLOGIE TOXOPLASMOSE<div id="i7" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>SEROLOGIE HEPATITE B<div id="i8" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>SEROLOGIE HEPATITE C<div id="i9" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>HIV<div id="i10" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Urée<div id="i11" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Créatinine<div id="i12" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Uricémie<div id="i13" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Agglutinines irréguliers<div id="i14" style="display:inline-block;margin-left:5px;"></div></div>
