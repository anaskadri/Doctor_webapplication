                        ...
                        <div class="row">
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" novalidate="" action="#" id="certificat">
                                            <span class="section">Bilan maladie coeliaque</span>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">IgA totales <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Ig antitransglutaminases <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Ig antigliadine <span class="required">*</span>
                                                     </label>
                                            ...
                                            <div class="form_group">
                                                <label class="control-label col-md-6 col-sm-6 col-xs-12" for="name" style="width: 250px;">Ig antiendomysium <span class="required">*</span>
                                                     </label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" id="content" style="display:none;">
                                <div style="font-size: 15pt;text-align:right;">Kenitra, le<div class="single_cal2" style="display:inline;margin-left:10px;margin-right:10px;"></div></div>
                                    <center><h1>BILAN MALADIE COELIAQUE</h1></center>
                                    <div id="certificat_body">
                                        ...
                                        <div>IgA totales <div id="i1" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Ig antitransglutaminases <div id="i2" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Ig antigliadine <div id="i3" style="display:inline-block;margin-left:5px;"></div></div>
                                        <div>Ig antiendomysium <div id="i4" style="display:inline-block;margin-left:5px;"></div></div>
