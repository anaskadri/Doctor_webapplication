    ...
    <body class="nav-md">
                    ...
                    <div class="">
                        ...
                        <div class="row">
                                ...
                                <div class="x_panel">
                                    <div class="x_content">
                                        ...
                                        <form class="form-horizontal form-label-left" novalidate="" action="#" id="certificat">
                                            <span class="section">Certificat médico-légale</span>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Victime de <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" id="victime" placeholder="" required="required" type="text">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Le <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Examen physique <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <textarea class="resizable_textarea form-control" placeholder="Examen" id="examen" form="form_traitement" style="margin: 0px 14.25px 0px 0px; height: 100px; width: 207px;" required></textarea>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ITT de <span class="required">*</span>
                                                    </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input class="form-control col-md-7 col-xs-12" id="nbr_jours" placeholder="" required="required" type="text">
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" id="content" style="display:none;">
                                    <center><h1>Certificat médico-légale</h1></center>
                                    <div id="certificat_body">
                                        <strong>Je soussigne,</strong> <div class="attestateur_nom" style="display:inline;margin-left:10px;margin-right:10px;"></div><div class="attestateur_prenom" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/>
                                        
                                        <strong>Certifie avoir examiné Le nommé : Mr /Mme </strong> <div class="patient_nom" style="display:inline;margin-left:10px;margin-right:10px;"></div><div class="patient_prenom" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/> 

                                        <strong>CIN :</strong> <div class="cin" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/> 
                                        
                                        <strong>Qui déclare être victime de :</strong><div class="victime" style="display:inline;margin-left:10px;margin-right:10px;"></div><strong>le : </strong><div class="date_victime" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/>

                                        <strong>Que l’examen physique ce jour montre : </strong> <div class="examen" style="display:inline;margin-left:10px;margin-right:10px;"></div><br/>

                                        <strong>Son état de santé nécessite une ITT de : </strong> <div class="nbr_jours" style="display:inline;margin-left:10px;margin-right:10px;"></div><strong>jours Sauf complications.</strong><br/>
                                        
                                        <p style="margin-top:70px;line-height:1"><strong>Ce certificat est délivré pour servir et valoir ce que de droit.</strong></p>

                                        <center><strong>Fait à Kenitra le </strong><div class="date_certificat" style="display:inline;margin-left:10px;margin-right:10px;"></div></center>
                                    </div>
        ...
        <script type="text/javascript">
            function fillValues() {
                ...
                var value6 = $("#victime").val();
                $('.victime').text(""+value6);
                
                var value7 = $("#single_cal2").val();
                $('.date_certificat').text(""+value7);
                
                var value8 = $("#single_cal1").val();
                $('.date_victime').text(""+value8);
                
                var value9 = $("#examen").val();
                $('.examen').text(""+value9);
                
                var value10 = $("#nbr_jours").val();
                $('.nbr_jours').text(""+value10);
            ...
            <script type="text/javascript">
                ...
                function Popup(data)
                {
                    ...
                    myWindow.document.write('<style>.no-print{display:none;} h1{margin-top:50px;} #certificat_body{font-size: 20pt;margin-top: 50px;line-height: 50pt;}</style></head><body >');
