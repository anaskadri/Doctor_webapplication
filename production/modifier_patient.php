                              ...
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_content">
                                    ...
                                    <form class="form-horizontal form-label-left" novalidate="" action="php/modifier/modifier_patient.php" method="post">
                                      <span class="section"><?php echo $infos_patient['nom_patient'].' '.$infos_patient['prenom_patient']; ?></span>

                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nom 
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="nom" value="<?php echo $infos_patient['nom_patient'];?>" placeholder="Nom" type="text">
                                        </div>
                                      </div>

                                      <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Prenom 
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="prenom" value="<?php echo $infos_patient['prenom_patient'];?>" placeholder="Prénom" type="text">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <div class="col-md-13 xdisplay_inputx form-group has-feedback">
                                             <input type="text" class="form-control has-feedback-left" id="single_cal2" placeholder="Date de naissance" aria-describedby="inputSuccess2Status2" style="padding-left:55px;" value="<?php echo $infos_patient['date_naissance'];?>" name="date_naissance">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="cin" value="<?php echo $infos_patient['cin_patient'];?>" placeholder="Cin" type="text">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="telephone" value="<?php echo $infos_patient['telephone_patient'];?>" placeholder="Téléphone" type="text">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="mutuel" value="<?php echo $infos_patient['mutuel_patient'];?>" placeholder="Mutuel" type="text">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                          <input class="form-control col-md-7 col-xs-12" name="adresse" value="<?php echo $infos_patient['adresse_patient'];?>" placeholder="Adresse" type="text">
                                        </div>
                                     </div>
                                      ...
                                      <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <input name="id_client" value="<?php echo $infos_patient['id_patient'];?>" type="hidden" />
                                          <button id="send" type="submit" class="btn btn-dark">Modifier</button>
                                        </div>
                                      </div>
                                    </form>
                                  </div>
