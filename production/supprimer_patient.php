                            ...
                            <div class="col-md-6">
                              <div class="x_panel">
                                <div class="x_content bs-example-popovers">
                                    ...
                                    <strong>Attention !</strong> si vous allez supprimer le patient, vous effacerez toutes ses données.
                                  </div>
                                    
                                    <form action="php/supprimer/supprimer_patient.php" method="post">
                                        <input hidden="hidden" value="<?php echo $id_patient; ?>" name="id_patient"/>
