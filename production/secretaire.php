                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" novalidate="" action="php/ajout/ajout_patient.php" method="post">
                      ...
                      <div class="item form-group bad">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" name="prenom" placeholder="Prénom" required="required" type="text">
                        </div>
                      <div class="alert">Veuillez inserer ici</div></div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12" name="telephone" placeholder="Téléphone" type="text">
                        </div>
                      </div>
